...
// Personalizamos los errores de validaci�n para devolver USR-002
builder.Services.Configure<ApiBehaviorOptions>(options =>
{
    options.InvalidModelStateResponseFactory = context =>
    {
        ...
        var mensaje = errores.Any()
            ? string.Join("; ", errores)
            : "Los datos del usuario son inv�lidos.";
        ...
        return new BadRequestObjectResult(new
        {
            ...
            errorCode = "USR-002",
            errorMessage = "Los datos del usuario son inv�lidos.",
...
// Log autom�tico de requests HTTP
