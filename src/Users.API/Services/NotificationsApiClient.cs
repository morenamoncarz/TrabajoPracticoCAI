...
// cliente http para avisarle a notifications api cuando pasa algo con un usuario
public class NotificationsApiClient
{
    ...
    public async Task Notificar(Guid usuarioId, string mensaje)
    {
        ...
        // si notifications esta caido el registro igual tiene que andar, asi que no propago el error
        try
        {
