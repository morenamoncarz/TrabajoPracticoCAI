...
// cliente http para avisarle a notifications api cuando cambia un producto
public class NotificationsApiClient
{
    ...
    public async Task Notificar(Guid usuarioId, string mensaje)
    {
        ...
        // si notifications esta caido el update igual tiene que andar, asi que no propago el error
        try
        {
